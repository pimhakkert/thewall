...
<!--    </nav>-->
   ...
   <div class="dashboard" id="dashboard" style="width: 90vw">
       ...
       <form class="dashboardProfileSettings" style="width: 85vw;">
           ...
           <form action="" class="dashboardProfileSettings" style="width: 85vw;">
               <div class="dashboardProfileSetting"><h5>Profile-icon:</h5></div><div><input class="profileIconSetting" type="file" name="fileToUpload" id="fileToUpload" accept="images/*"></div>
