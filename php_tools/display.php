...
<div class="galleryItem">
    ...
    <div class="galleryItemScore modalButton">
        <div class="<?php echo $upvoteResult; ?>" <?php echo "id='upvote".$imageID."'"; ?> onclick="scoreImage(<?php echo $imageID.","."'".$user."',".$i; ?>,'up')"></div>
        <p class="galleryItemScoreText" <?php echo "id='scoreText".$imageID."'"; ?>> <?php echo $image_results['score']; ?></p>
        <div class="<?php echo $downvoteResult; ?>" <?php echo "id='upvote".$imageID."'"; ?> onclick="scoreImage(<?php echo $imageID.","."'".$user."',".$i; ?>,'down')"></div>
    </div>
